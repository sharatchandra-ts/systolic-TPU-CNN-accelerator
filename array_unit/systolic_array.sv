module systolic_array #(
    ...
    input logic valid_in [COLUMNS], // New input array
        ...
        for (r = 0; r < ROWS; r++) begin : row_gen
            for (c = 0; c < COLUMNS; c++) begin : column_gen    
                mac_unit #(
                    ...
                    .valid_out (valid_wire[r+1][c]), // Flowing North-to-South
                    .a_in (a_wire[r][c]),
    ...
    generate
        for (i = 0; i < COLUMNS; i++) begin
            ...
            assign valid_out_final[i] = valid_wire[ROWS][i];
        end
    endgenerate
